...
class ColorPicker(QtGui.QWidget):
    ...
    def onCurrentColorChanged(color):
        ...
        data = ColorPicker.rgb_color_array
        data_as_str = ', '.join(str(i) for i in data)
        # we join the array elements with a comma and a space since we need to send a string through the serial
